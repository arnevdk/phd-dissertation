...
\todo{why is spatial resolution good}
...
Electrocorticography (ECoG) is a powerful method
...
Some impressive recent breakthroughs\todo{cite} have been realized using
invasive mictroelectrode arrays and µECoG.
Recent advances in recording technology focus on improving implant durability and
lifetime\todo{cite flexible}, or on balancing the invasiveness tradeoff by
finding new, minimally invasive ways to record from closer to the cortex.
...
ac{eeg} cheap and practical, non-invasive, high-temporal resolution, but noise, suffers from volume

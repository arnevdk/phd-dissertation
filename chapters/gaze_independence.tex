...
ophthalmological and neurological pathophysiology for each of the specific
conditions.
...
Instead of categorizing patients we will refer to these groups as individuals
with \ac{sspi} and, if eye motor skills are affected,  \ac{sspgi}, in line with
the terminology used by~\textcite{FrieDOken2020} (see
Figure~\ref{fig:gaze_independence/venn}).

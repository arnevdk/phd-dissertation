...
\begin{subappendices}
  ...
  \begin{table}[!h]
      ...
      \caption{Accuracies for \textsc{stbf-struct}.}
  \end{table}
  \begin{table}[!h]
	    \input{chapters/stbf_struct-acc-stbf_loocv.tex}
      \caption{Accuracies for \textsc{stbf-shrunk}.}
  \end{table}
  \begin{table}[!h]
	    \input{chapters/stbf_struct-acc-stbf_emp.tex}
      \caption{Accuracies for \textsc{stbf-emp}.}
  \end{table}
  \begin{table}[!h]
	    \input{chapters/stbf_struct-acc-xdawn_rg.tex}
      \caption{Accuracies for \textsc{xdawn+rg}.}
  \end{table}

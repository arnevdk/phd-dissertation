...
% Kronecker-structured LDA ====================================================
  ...
  \begin{figure}
		\includegraphics[width=\linewidth]{figures/stbf_struct/accuracy.eps}
	...
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/stbf_struct/training_time.eps}
  ...
  \todo{Include part kronlda, check notes in journal}
\section{Introduction}

LCMV struct might be to restrictive
Toeplitzlda
MEG paper

\section{Methods}
\subsection{Spatiotemporal Linear Discriminant Analysis}
\subsection{The single Kronecker product covariance model}
\begin{equation}
...
\subsection{Kronecker sum covariance estimation}
\subsection{Classification}
\section{Results}
\section{Discussion}

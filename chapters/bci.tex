...
\todo{search for ??}
\todo{acro usage in chapters}
\todo{are textcites used when necessary?}
...
electrical activity.
For several reasons laid out in \autoref{sec:bci-recording}, the electrical modality is
...
\begin{figure}[t]
  ...
  \end{subfigure}
\end{figure}
\todo{full spatiotemporal erp response}

\begin{tikzpicture}
    % First subplot (low jitter) positioned relative to center
    \begin{axis}[
        at={(-3cm,0cm)}, % Adjust position to the left, closer to the center
        anchor=center,
        ...
        title style={yshift=-10pt}, % Adjust title position to make it closer to the plot
        ]
    ...
    \begin{axis}[
        at={(3cm,0cm)}, % Adjust position to the right, closer to the center
        anchor=center,
        width=7cm, height=6cm,
        xmin=20, xmax=80,
        ymin=-0.1, ymax=1.1,

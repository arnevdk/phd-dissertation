...
\begin{cvlist}
	...
	\cvitem{Ph.D.\ in Control Science and Signal Processing}{University of
		Lille, 2024}
	\cvitem{M.Sc.\ in Engineering Science: Computer Science}{KU Leuven, 2020}
...
\begin{cvlist}
	\cvitem{Clinical Trial Sponsorship Program}{Zeto, 2024 \\
		Our research project titled ``A gaze-independent Visual Brain-Com\-pu\-ter
...
\begin{cvlist}
	...
	\cvitem{An EEG connectivity analysis of Dementias}{Zoe Barinaga, KU Leuven, 2023--2024}

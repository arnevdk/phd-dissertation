...
Tensor decoding methods offers a powerful approach by preserving the multiway structure
...
The previous two methods did not yet yield results specifically in gaze-independent
decoding.
...
naturally interact with a \ac{bci}, compared to standard overt and covert \ac{vsa} tasks.

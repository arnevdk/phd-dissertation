...
impairment\fnlis.
\todo{from a solution engineering point of view, the etiology does not matter that
much}.
\todo{fill out which definition we use, wolpaw criteria}
\todo{cite studies per pathology}
\todo{check definition in Wolpaw\&Wolpbaw Brain-Computer Interfaces: Principles
and Practice}

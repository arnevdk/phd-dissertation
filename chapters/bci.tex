...
\todohsm{Start with state of the art before theses.}
\todohsm{objectives at the end of chapter 1}
\todohsm{Introduction part: chapter 1 rationale, chapter 2: literature/sota}
...
A \ac{bci} operates according to a specified paradigm, which defines the method by which interaction is conducted.
...
\todohsm{bring more structure, more subtitles}
...
their brain activity.\todohsm{in "passive bci", the user is not supposed to express "intentions". ragher start with active "}
...
Compared to active \ac{bci}, reactive paradigms usually require more effort\todohsm{is this the case?}

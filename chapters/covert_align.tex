...
\ac{vsa}\todo{qualitative, discuss}.
...
decreases as the number of repetitions increases.\todo{qualitative}
...
selection accuracy.\todo{qualitative}
...
\ac{wcble} in CVSA-ERP.\todo{qualitative}
...
Figure~\ref{fig:covert-align/covert-cross-eval} and Figure~\ref{fig:covert-align/aloise2012-cross-eval} show
...
evaluated settings, similar to the within-subject conditions.\todo{qualitative}
...
except for within-overt \ac{vsa} decoding.\todo{qualitative}
...
\cite{Arico2014}\todo{qualitative} could also
be explained by overfitting on artifacts amplified by aligning, since their
method is not evaluated on unseen data, as opposed to ours.\todo{qualitative}

...
compared to visual paradigms\todo{qualitative}.
...
variability~\cite{Severens2014,Reichert2020b}.\todo{qualitative}
...
their study only used a few stimulation targets.\todo{qualitative}
...
the \ac{erp} is lower than in overt attention settings\todo{qualitative}.

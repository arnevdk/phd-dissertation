...
\begin{tikzpicture}[
  ...
  %\begin{scope}[shift={(1,1.2)}]
    ...
    %% Text in rectangles
    \node[align=center] at ({-\center}, {\center+1.5*\textspacing}) {motor\\imagery};
    \node[align=center] at ({-\center}, {\center}) {imagined\\speech};
    ...
    \node[align=center] at ({-\center+\textspacing}, {-\center-\textspacing}) {clinical \\ neuroimaging};

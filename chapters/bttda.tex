...
\begin{figure}[t]
  ...
  \caption[The \acs{hoda} backward projection.]{%
...
A forward model should make sure that reconstruction error is minimized.
...
Introducing a flexible block-term tensor model as underlying structure

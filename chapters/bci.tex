...
\fullpagefigct{%
  \includegraphics[width=\paperwidth]{figures/bci/bci_loop.pdf}
}{%
  The \ac{bci} loop.
...
\fullpagefigct{%
  \includegraphics[width=\paperwidth]{figures/bci/recording_modalities.pdf}
}{%
...
Reactive \ac{bci} take another approach, by providing the user a discrete set of
...
\paragraph{P1}
The P1 component occurs approximately 100 ms after stimulus presentation.
...
\paragraph{N1}
The N1 component peaks around 150 to 200 ms post-stimulus.
...
\paragraph{P2}
The P2 component occurs between 200 to 300 ms.
...
\paragraph{N2}
Peaking around 200 to 350 ms, the N2 component is associated with cognitive
...
\paragraph{P3}
The P3 component is elicited in oddball paradigms and peaks around 300 ms
post-stimulus.
...
\paragraph{Late Positive Potential (LPP)}
The LPP is a later component occurring beyond 400 ms.
...
information, LPP serves as an indicator of cognitive appraisal beyond mere
recognition tasks.
...
mechanisms.
These components not only inform the design of an effectiv oddball BCI system

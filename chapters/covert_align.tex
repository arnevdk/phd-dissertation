...
\emph{This chapter was published as part of~\textcite{VanDenKerchove2024}.}
...
\Cref{fig:single_trial_roc_auc_diff} shows a comparison of \ac{rocauc}
...
\Cref{fig:block_evaluation} shows the cross-validated \ac{bci} selection

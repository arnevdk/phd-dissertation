...
A survey in by \textcite{Riccio} from 2012 reported that \acp{itr} ranged between
...
but with vibrotactile stimulation at different spatial locations and/or
frequencies~\cite{Han2020}.
Some noteworthy advancements achieved an \ac{itr} of 14.77
bits/min~\cite{Liu2019} and 20.73 bits/min~\cite{Herweg2016} with tactile
oddball stimulation through highly optimized stimulation?
Still, other recent tactile paradigm studies~\cite{Herweg2016a,Han2020,Jin2020,Li2019,Eidel2022}
...
settings when coupled with visual oddball stimulation in a hybrid paradigm.
...
BCIs for individuals affected with severe vision loss or
...
This leads us to adopt the following hypothesis: \emph{it is possible to improve
the (gaze-independent) accuracy of a spatially organized visual oddball
\ac{erp}-based brain computer interface by using a suited decoding strategy}.
...
decoders, and the findings have be verified in experiments with

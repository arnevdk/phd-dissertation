...
Several studies show that performance drops in covert VSA \todo{[2, 1], our
study}, necessitating gaze-independent solutions.
Our previous study, presented in chapter \todo{ref chapter}, indicates gaze-independent performance can be
...
\todo{goal is class 1, but challenging to perform research experiments and to
recruit, cite wolpaw}
...
\begin{enumerate}
  ...
  \todo{specific cutoff based on vision}
...
\Ac{isi} was increased to\tod{number} to decrease task difficulty.

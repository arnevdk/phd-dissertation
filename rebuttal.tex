...
Major comments:
\begin{enumerate}
	\item \todo{quantify qualitative statements} Throughout the text, qualitative
    statements have been qualified where possible and appropriate.
	...
	feedback have indeed not reported in this thesis, but were foreseen to take
...
\begin{enumerate}
    ...
    While both approaches are valid strategies and commonly used, I believe

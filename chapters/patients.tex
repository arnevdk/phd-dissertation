...
\ac{vsa} were close to those in the overt \ac{vsa}.\todo{qualitative}
A substantial decrease in performance from the overt setting to the free
setting was observed for
subjects PC3 and PC4.\todo{qualitative}
For PB2, who also relied on covert \ac{vsa} during the uncued free \ac{vsa}
setting, there was no notable decrease in performance.\todo{qualitative}
...
gaze was uncued.\todo{qualitative}

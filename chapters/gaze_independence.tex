...
\section{Eye motor impairment in individuals with \acs{sspi}}%
...
\todo{to the CNS (stroke, spinal chord injury, tbi) or neurodegenerative diseases}

Unfortunately, many individuals in the \ac{bci} target population suffer to
some extent from eye motor disability, requiring \ac{bci}s adapted to their condition.
...
The most severely impaired of these patients toghether constitute the \ac{lis}
patient group, which forms one of the main \ac{bci} target populations.
...
\todohsm{Address more systematically.}
...
can modulate specific \ac{erp} components
that are more sensitive to stimulation in the visual
periphery~\cite{Schaeff2012,Xu2022}.\todo{discuss Xu2022}

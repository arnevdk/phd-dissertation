...
% Kronecker-structured LDA ====================================================
  ...
  \subsection{Extension to \ac{lda}}
  \label{sec:stbf-struct-kronlda}
  \todo{cite proof (or reiterate)}
...
\todo{
in conclusion: LCMV struct might be to restrictive
Toeplitzlda MEG paper}

\todo{in conclusion: extension to the TFR domain}
%\begin{equation}
